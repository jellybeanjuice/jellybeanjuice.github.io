...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13168284);
}
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.StartCode.GDMonsterObjects2, gdjs.StartCode.GDMonsterObjects3);
...
gdjs.StartCode.asyncCallback13159212 = function (runtimeScene, asyncObjectsList) {
...
gdjs.StartCode.idToCallbackMap.set(13159212, gdjs.StartCode.asyncCallback13159212);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.StartCode.asyncCallback13159212(runtimeScene, asyncObjectsList)), 13159212, asyncObjectsList);
}
}
