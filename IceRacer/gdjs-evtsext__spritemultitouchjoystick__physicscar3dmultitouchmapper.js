...
gdjs.evtsExt__SpriteMultitouchJoystick__PhysicsCar3DMultitouchMapper.PhysicsCar3DMultitouchMapper = class PhysicsCar3DMultitouchMapper extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.PhysicsCar3D !== undefined)
      this._behaviorData.PhysicsCar3D = behaviorOverriding.PhysicsCar3D;
    ...
    if (behaviorOverriding.SteerJoystickIdentifier !== undefined)
      this._behaviorData.SteerJoystickIdentifier = behaviorOverriding.SteerJoystickIdentifier;
    if (behaviorOverriding.SpeedJoystickIdentifier !== undefined)
      this._behaviorData.SpeedJoystickIdentifier = behaviorOverriding.SpeedJoystickIdentifier;
    if (behaviorOverriding.HandBrakeButton !== undefined)
      this._behaviorData.HandBrakeButton = behaviorOverriding.HandBrakeButton;
